"""
Django settings for AllerGeoBackend project.
...
WSGI_APPLICATION = 'AllerGeoBackend.wsgi.application'
...
# Auth model for the project
AUTH_USER_MODEL = "users.AllergicUser"
